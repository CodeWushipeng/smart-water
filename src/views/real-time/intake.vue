  ...
  <div class="overview">
    ...
    <div class="table-wrap">
      <el-table :data="pumpData" style="width: 100%" :header-cell-style="headerStyle" border>
        ...
        <el-table-column prop="name" label="仪器编码"></el-table-column>
        <el-table-column prop="address" label="测量时间"></el-table-column>
        <el-table-column prop="address" label="仪器日取水量（m³）"></el-table-column>
        <el-table-column prop="address" label="日工日取水量（m³）"></el-table-column>
      </el-table>
      <div class="page">
        <el-pagination
        background
